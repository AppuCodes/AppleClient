...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn)
    {
        ...
        int k1 = BossStatus.bossName != null && BossStatus.statusBarTime > 0 ? 22 : 2;
        int l1 = i1 * j4 + (j4 - 1) * 5;
        ...
        if (list1 != null)
        {
            drawRect(width / 2 - l1 / 2 - 1, k1 - (BossStatus.bossName != null ? 1 : 3), width / 2 + l1 / 2 + 1, k1 + list1.size() * this.mc.fontRendererObj.FONT_HEIGHT, Integer.MIN_VALUE);
