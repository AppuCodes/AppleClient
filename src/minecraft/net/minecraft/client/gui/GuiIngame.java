...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        Apple.eventBus.post(EventRender.get());
    ...
    {
        Mod scoreboardMod = Apple.modsManager.getMod("Scoreboard");
        ...
        for (Object score1 : arraylist1)
        {
            ...
            ToggleSetting textShadow = (ToggleSetting) scoreboardMod.getSetting("Text Shadow"), showNumbers = (ToggleSetting) scoreboardMod.getSetting("Show Numbers");
            
            if (scoreboardMod.isEnabled() && (textShadow.enabled || !showNumbers.enabled))
            {
                if (textShadow.enabled)
                {
                    this.getFontRenderer().drawStringWithShadow(s1, j, l, 553648127);
                    
                    if (showNumbers.enabled)
                    {
                        this.getFontRenderer().drawStringWithShadow(s2, i1 - this.getFontRenderer().getStringWidth(s2), l, 553648127);
                    }
                }
            ...
            if (k == arraylist1.size())
            {
                ...
                if (scoreboardMod.isEnabled() && textShadow.enabled)
                {
                    this.getFontRenderer().drawStringWithShadow(s3, j + i / 2 - this.getFontRenderer().getStringWidth(s3) / 2, l - this.getFontRenderer().FONT_HEIGHT - 2, 553648127);
                }
